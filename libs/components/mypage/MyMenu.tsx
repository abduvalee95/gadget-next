					...
					<Stack className={'section'} style={{ height: user.memberType === 'AGENT' ? '228px' : '153px' }}>
						...
						<List className={'sub-section'}>
							{user.memberType === 'AGENT' && (
								<>
									<ListItem className={pathname === 'addNewGadget' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'addGadget' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
												{category === 'addNewGadget' ? (
									...
									<ListItem className={pathname === 'myGadgets' ? 'focus' : ''}>
										<Link
											href={{
												pathname: '/mypage',
												query: { category: 'myGadgets' },
											}}
											scroll={false}
										>
											<div className={'flex-box'}>
