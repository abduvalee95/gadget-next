...
const Chat = () => {
	...
	const user = useReactiveVar(userVar); //login bolgan Userdi Malumotlarini olish mm
	const socket = useReactiveVar(socketVar); // Saqlanilgan socket client instance
		...
		<Stack className="chatting">
			...
			<Stack className={`chat-frame ${open ? 'open' : ''}`}>
				<Box className={'chat-top'} component={'div'}>
					...
					<RippleBadge style={{ margin: '-18px 0 0 22px' }} badgeContent={onlineUsers} />
				</Box>
